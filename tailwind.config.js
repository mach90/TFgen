...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'bgIsoline': "url('/isoline.svg')",
        'bgPattern': "url('/bgPattern.png')",
        'bgCard': "url('/bgCard.png')",
        'bgForm': "url('/bgForm.png')",
      },
      cursor: {
        'triangle': 'url("/triangle-cursor.svg"), default',
        'finger': 'url("/finger-cursor.svg"), pointer',
        'eye': 'url("/eye-cursor.svg"), zoom-in',
        'input': 'url("/input-cursor.svg"), text',
      },
    },
  },
  plugins: [],
