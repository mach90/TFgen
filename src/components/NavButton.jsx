export default function NavButton({children, active, bounce, onMouseOver, onMouseOut}) {
    return (
      ...
      {!active && !bounce &&
        <button onMouseOver={onMouseOver} onMouseOut={onMouseOut} type="button" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-base font-medium flex gap-2">
          {children}
        </button>
      }
      {bounce &&
